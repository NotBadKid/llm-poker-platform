            ...
            <div className="w-[80%] mt-18">
                ...
                <div
                    ...
                    <div className="flex items-center justify-center flex-wrap gap-x-8 gap-y-3">
                        ...
                        <div className="flex items-center gap-2">
                            <span
                                className="text-[#A855F7] bg-[#A855F7]/10 border border-[#A855F7]/30 px-3 py-1 rounded-lg text-sm">Default Prompts</span>
                        </div>
                        <div className="flex items-center gap-2">
                            <span
                                className="text-[#A855F7] bg-[#A855F7]/10 border border-[#A855F7]/30 px-3 py-1 rounded-lg text-sm">Default Temperature</span>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-slate-800 rounded-2xl p-8 border border-slate-700">
                    <h2 className="text-2xl font-semibold text-purple-500 mb-6 ">Statistics</h2>
                    {
                        ...
                        </div> : <StatsTable players={playerStats}/>
                    }
                </div>
            </div>
        </div>
